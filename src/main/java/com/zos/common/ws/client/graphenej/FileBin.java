...
import com.zos.common.ws.client.graphenej.crypto.SecureRandomStrengthener;
import com.zos.common.ws.client.graphenej.models.backup.WalletBackup;
...
public abstract class FileBin {
    private static final Logger LOGGER = LoggerFactory.getLogger(FileBin.class);
    ...
    public static WalletBackup deserializeWalletBackup(byte[] input, String password){
        try{
            ...
            LOGGER.info("Wallet str: "+walletString);
            return new GsonBuilder().create().fromJson(walletString, WalletBackup.class);
        }catch(NoSuchAlgorithmException e){
            LOGGER.info("NoSuchAlgorithmException. Msg: "+e.getMessage());
