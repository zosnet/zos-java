...
import com.zos.common.ws.client.graphenej.operations.LimitOrderCreateOperation;
...
public class Transaction implements ByteSerializable, JsonSerializable {
    ...
    public void setPrivateKey(String key){
        this.privateKey =DumpedPrivateKey.fromBase58(null, key).getKey();
    }
    /**
     * BlockTransaction constructor.
     *
...
//            System.out.println("----serializedTransaction:" + Util.bytesToHex(serializedTransaction));
//            byte[] serializedTransaction2 =Util.hexToBytes(Util.bytesToHex(serializedTransaction));
//            if(Arrays.equals(serializedTransaction, serializedTransaction2)){
...
//            System.out.println("----serializedTransaction:" + Util.bytesToHex(serializedTransaction));
    ...
    public String getGrapheneSignature2() {
        boolean isGrapheneCanonical = false;
        byte[] sigData = null;
        String x = null;
...
//            System.out.println("----serializedTransaction:" + Util.bytesToHex(serializedTransaction));
            x = Util.bytesToHex(serializedTransaction);
        }
        //String s = Util.byteToString(Sha256Hash.hash(this.toBytes()));
        //String sign = SignatureUtil.signature(s,WSConstants.WS_ACCOUNT_PRIKEY);
        return x;
...
//        System.out.println(this.toBytes());
//        System.out.println(Util.hexToBytes(getChainId()).length);
//        System.out.println(this.toBytes().length);
