...
import com.zos.common.ws.client.graphenej.enums.ObjectType;
import com.zos.common.ws.client.graphenej.interfaces.SubscriptionListener;
...
public class SubscriptionResponse {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubscriptionResponse.class);
        ...
        public void removeSubscriptionListener(SubscriptionListener subscriptionListener){
            if(listenerTypeCount.containsKey(subscriptionListener.getInterestObjectType())){
                ...
                if(currentCount > 0){
                    ...
                    LOGGER.info("Trying to remove subscription listener, but none is registered!");
                }
            }
        }
