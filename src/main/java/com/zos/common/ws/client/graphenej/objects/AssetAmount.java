...
import com.zos.common.ws.client.graphenej.errors.IncompatibleOperation;
...
public class AssetAmount implements ByteSerializable, JsonSerializable {
    ...
    public AssetAmount(long amount, String asset) {
        this.amount = UnsignedLong.valueOf(amount);
    ...
    public static class AssetAmountSerializer implements JsonSerializer<AssetAmount> {
        ...
        @Override public JsonElement serialize(AssetAmount assetAmount, Type type, JsonSerializationContext jsonSerializationContext) {
    ...
    public static class AssetAmountDeserializer implements JsonDeserializer<AssetAmount> {
        ...
        @Override public AssetAmount deserialize(JsonElement json, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
