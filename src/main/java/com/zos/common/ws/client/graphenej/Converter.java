...
import com.zos.common.ws.client.graphenej.errors.IncompleteAssetError;
import com.zos.common.ws.client.graphenej.models.BucketObject;
...
//        LOGGER.info(String.format("base: %d, quote: %d", baseValue.longValue(), quoteValue.longValue()));
...
//        LOGGER.info(String.format("conversion rate: %.4f, precision factor: %.2f", conversionRate, precisionFactor));
