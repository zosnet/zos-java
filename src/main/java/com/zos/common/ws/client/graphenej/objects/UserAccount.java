...
import com.zos.common.ws.client.graphenej.*;
...
public class UserAccount extends GrapheneObject implements ByteSerializable, JsonSerializable {
    ...
    public UserAccount(String id, int state, long hash64, int expiration){
        super(id);
        this.state = state;
