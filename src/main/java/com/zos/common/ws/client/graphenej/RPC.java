...
public class RPC {
    ...
    public static final String GET_ACCOUNT_ATTACHINFO = "get_account_attachinfo";
    ...
    public static final String CALL_GET_BLOCK_IDS = "get_block_ids";
    public static final String LIST_BITLENDER_ORDER = "list_bitlender_order";
    public static final String VERTIFY_TRANSACTION = "vertify_transaction";
    public static final String VERTIFY_TXID = "get_transaction_by_id";
    public static final String LOCKTOKENS = "get_locktokens";
    public static final String CALL_GATEWAY_DEPOSIT = "gateway_deposit";

    public static final String BROADCAST_TRANSACTION = "broadcast_transaction";
    public static final String BROADCAST_TRANSACTION_WITH_CALLBACK = "broadcast_transaction_with_callback";
    public static final String GET_TRANSACTION_HASH = "get_transaction_hash";
}
