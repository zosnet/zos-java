...
import com.zos.common.ws.client.graphenej.objects.GrapheneObject;
...
public class DynamicGlobalProperties extends GrapheneObject implements Serializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(DynamicGlobalProperties.class);
...
//    public static final String KEY_WITNESS_BUDGET = "witness_budget";
    ...
    public static final String KEY_MINER_BUDGET = "miner_budget";
    public static final String KEY_MINER_PAYED = "miner_payed";
    public static final String KEY_WORKER_BUDGET = "worker_budget";
    public static final String KEY_WORKER_PAYED = "worker_payed";
    public static final String KEY_COUPON_SUPPLY = "coupon_supply";
    public static final String KEY_MINER_SUPPLY = "miner_supply";
    public static final String KEY_MINER_FEE_USED = "miner_fee_used";
    public static final String KEY_BUDGET_SUPPLY = "budget_supply";
    public static final String KEY_BUDGET_FEES_USED = "budget_fees_used";
    ...
    public Object miner_budget;
    public Object miner_payed;
    public long worker_budget;
    public long worker_payed;
    public long coupon_supply;
    public long miner_supply;
    public long miner_fee_used;
    public long budget_supply;
    public long budget_fees_used;
