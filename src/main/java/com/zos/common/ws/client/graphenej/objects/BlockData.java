...
public class BlockData implements ByteSerializable {
    ...
    @Override public byte[] toBytes() {
        ...
        //            }else if(i < REF_BLOCK_NUM_BYTES + REF_BLOCK_PREFIX_BYTES){
        ...
        //            }
        //        }
        return Bytes.concat(Varint.writeUnsignedSize(this.refBlockNum), Varint.writeUnsignedSize(this.refBlockPrefix), Varint.writeUnsignedSize(this.expiration));
    }
}
